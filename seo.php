...
require_once 'include/__f.php';

require_once 'include/__rw.php';
...
if(is_admin()){
    ...
    require_once 'include/__c.php';

    require_once 'include/__a.php';

    require_once 'include/__m.php';

    require_once 'include/__i.php';

    require_once 'include/__t.php';

}else{

    require_once 'include/__r.php';

    if(isset($_os['_tbc_']) && $_os['_tbc_']){

      require_once 'include/__b.php';
